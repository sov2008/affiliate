...
// .wrangler/tmp/bundle-Mjb9Ft/checked-fetch.js
...
// .wrangler/tmp/bundle-Mjb9Ft/strip-cf-connecting-ip-header.js
  ...
  async fetch(request, env, ctx) {
    ...
    if (pathname === "/click") {
      ...
      if (campaignId) {
        ...
        let data = await env.STATS_KV.get(key, "json");
        if (!data)
          data = { clicks: 0, leads: 0, sales: 0, revenue: 0 };
        data.clicks++;
    ...
    if (pathname === "/stats") {
      ...
      const v1Data = await env.STATS_KV.get(`stats_${campaignId}_v1`, "json") || { clicks: 0, leads: 0, sales: 0, revenue: 0 };
      const v2Data = await env.STATS_KV.get(`stats_${campaignId}_v2`, "json") || { clicks: 0, leads: 0, sales: 0, revenue: 0 };
      const calculateCR = /* @__PURE__ */ __name((d) => d.clicks > 0 ? ((d.leads + d.sales) / d.clicks * 100).toFixed(2) : 0, "calculateCR");
      const result = {
        campaignId,
...
// .wrangler/tmp/bundle-Mjb9Ft/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Mjb9Ft/middleware-loader.entry.ts
