...
| 4. Have they **deflected** personal questions or avoided depth? |  |
| 5. Is the profile **verified** on FlirtCheck or a trusted community? |  |
...
```json
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How can I differentiate a confident person from a covert narcissist in a bio?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Confidence is backed by concrete achievements and humility (e.g., \"I led a team of 10\"). Covert narcissists use vague superlatives (\"I'm the best\") and avoid specifics."
      }
    },
    {
      "@type": "Question",
      "name": "Are mirror selfies always a red flag?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Not always, but a high concentration (> 50 %) suggests an over‑focus on self‑image, a common narcissist trait. Pair this with other cues before deciding."
      }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "Can love‑bombing be genuine?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Genuine affection builds gradually. Immediate, intense praise and future talk within days is a classic love‑bombing tactic used by narcissists to gain control."
      }
    }
  ]
}
