...
**Дата и время генерации:** 2026-09-01T09:10:44.430Z  
...
| :--- | :--- | :--- | :---: | :---: |
| **Case A: Высокоинтентная органическая тема** | `COMPLIANT` / Score ≥ 80 | `COMPLIANT` (Score: **92/100**) | **2422 ms** | ✅ **ПРОЙДЕН** |
| **Case B: Агрессивный спам и стоп-слова** | `REJECTED` / Score < 80 | `REJECTED` (Score: **0/100**, Триггеров: **9**) | **1 ms** | ✅ **ПРОЙДЕН** |
...
- **Всего бандлов сохранено на диске**: **16**.
